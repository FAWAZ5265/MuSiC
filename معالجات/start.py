        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "قروب السورس", url=f"https://t.me/Nolx_Chat{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "قناه السورس", url=f"https://t.me/Nolx_Channel{UPDATES_CHANNEL}")               
                 ],[
                    InlineKeyboardButton(
                        "مطور السورس", url="https://t.me/WtttW"
                    )
                ]
            ]
        ),
...
- رفض إرسال رسالة إلى المساعد في الخاص.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "قروب الدعم", url=f"https://t.me/Nolx_Chat{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "قناة السورس", url=f"https://t.me/Nolx_Channel{UPDATES_CHANNEL}"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "مطور السورس", url=f"https://t.me/WtttW"
                    )
                ]
            ]
        )
